...
class Adaptable_CURL { 
     protected $_useragent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.113 Safari/537.36'; 
     protected $_url; 
     protected $_followlocation; 
     protected $_timeout; 
     protected $_maxRedirects; 
     protected $_cookieFileLocation = './cookie'; 
     protected $_post; 
     ...
     { 
         ...
         $this->_cookieFileLocation = dirname(__FILE__).'/cookie'; 
...
function file_get_html($url, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
{
	...
	$curl_handler = new Adaptable_CURL($url);
	$curl_handler->createCurl($url);
	$contents = $curl_handler->__toString();
